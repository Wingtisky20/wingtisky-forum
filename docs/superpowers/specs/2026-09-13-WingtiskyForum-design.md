...
|---|---|---|---|
| **M0** 启动与基建 | GitHub 仓库、多模块骨架、CLAUDE.md / STATUS / ADR 机制、**提交规范落地（`.gitattributes`、`.gitmessage` 模板、`commit.template`）**、CI 骨架、**ES8 + Kafka3.9 安装**、目录骨架、术语表 | 1 周 | `mvn compile` 过 · CI 绿 · ES/Kafka **启动验证** `[REAL]` · **提交模板生效** |
